#!/bin/bash -e
#SBATCH --job-name=k4_dilated
#SBATCH --output=/nesi/project/uoa04396/isin038/logs/k4_dilated_%A_%a.out
#SBATCH --error=/nesi/project/uoa04396/isin038/logs/k4_dilated_%A_%a.err
...
echo "Training Dataset003_PialK4 | Dilated Conv | Fold ${FOLD}"
echo "Start: $(date)"
nnUNetv2_train 003 3d_fullres ${FOLD} -tr nnUNetTrainer_DilatedConv
echo "End: $(date)"
