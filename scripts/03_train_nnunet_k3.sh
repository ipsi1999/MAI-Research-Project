...
#SBATCH --output=/nesi/project/uoa04396/isin038/logs/nnunet_train_k3_%j.out
#SBATCH --error=/nesi/project/uoa04396/isin038/logs/nnunet_train_k3_%j.err
...
echo ">>> Training Dataset002_PialK3, 3d_fullres, fold ${FOLD} ..."
